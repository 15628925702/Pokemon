...
public class Battle1pScene extends Scene{
    ...
    public void start(Stage primaryStage) throws IOException, SQLException {
        ...
        PokemonData pokeMe = new PokemonData();
        switch(Data.ID){
            case 1: pokeMe=pokemon2;
                break;
            case 2: pokeMe=pokemon1;
                break;
            case 3: pokeMe=pokemon3;
                break;
            case 4: pokeMe=pokemon4;
                break;
        }
        Battle1p battle = new Battle1p();
        battle.initBattle(pokeMe,pokemon5,this);
    }
